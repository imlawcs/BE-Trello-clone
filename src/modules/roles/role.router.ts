...
router.post("/create", auth.authenticateToken, validate.validateCreateRole, rbac.checkPermission(Permission.CREATE_ROLE), controller.createRole);
router.put('/update/:id?', auth.authenticateToken, validate.validateUpdateRole, rbac.checkPermission(Permission.UPDATE_ROLE), controller.updateRole);
